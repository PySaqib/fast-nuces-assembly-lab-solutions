...
;                                    Chapter #9(Q8)          
;**************************************************************************************************
; Write a TSR to clear the screen when CTRL key is pressed and restore it
; when it is released.
...
push                    cx
push                    di
; nested loop to waste some time
mov                     cx, 0xFF
delay1:
mov                     di, 0xFFF
delay2:
...
push                    es
push                    ds
; points source to video memory
mov                     ax, 0xb800
mov                     ds, ax
mov                     si, 0
; points destination to buffer
mov                     ax, cs
mov                     es, ax
mov                     di, buffer
mov                     cx, 2000
...
push                    es
push                    ds
; set destination to video memory
mov                     ax, 0xb800
mov                     es, ax
mov                     di, 0
; points source to buffer
mov                     ax, cs
mov                     ds, ax
mov                     si, buffer
mov                     cx, 2000
